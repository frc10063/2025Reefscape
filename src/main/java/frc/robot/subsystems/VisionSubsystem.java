...
public class VisionSubsystem extends SubsystemBase {
  ...
  private static final Vector<N7> stateStdDevs = VecBuilder.fill(0.05, 0.05, Units.degreesToRadians(5), 0.05);
  private static final Vector<N5> localMeasurementStdDevs = VecBuilder.fill(Units.degreesToRadians(0.01), 0.01, 0);
  private static final Vector<N3> visionMeasurementStdDevs = VecBuilder.fill(0.5, 0.5, Units.degreesToRadians(10));

  // im watching someone who paramatrized this why is it mad at me
  ...
  // its too late for me to find a way to fix this
  public Pose2d findBestTagPose() {
  ...
  public void periodic() {
    ...
    field2d.setRobotPose(getCurrentPose()); // m_swerve.getPose() maybe??
  }
}
